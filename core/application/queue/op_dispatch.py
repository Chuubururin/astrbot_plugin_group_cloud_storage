...
scan/sync/file operations/essence/transfer/batch and other kinds, capacity
integration, and scan progress throttling all live in this module, testable
independently of the Star host.  The two file-scan loops themselves live in
op_file_scan.py (FileScanMixin), leaving this module a routing table.
"""
...
from .op_file_scan import FileScanMixin
...
class OpDispatcher(FileScanMixin, CapacityMixin):
    def __init__(
        self,
        services: object,
        api: object,
